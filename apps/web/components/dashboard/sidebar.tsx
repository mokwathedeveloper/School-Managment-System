...
export function Sidebar({ collapsed = false, onClose, onToggle }: SidebarProps) {
  ...
  const navigation = [
    ...
    { name: 'Attendance Matrix', href: '/dashboard/attendance', icon: UserCheck, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'DEPUTY_HEAD_TEACHER', 'TEACHER', 'CLASS_TEACHER'] },
    { name: 'Examination Hub', href: '/dashboard/exams', icon: Trophy, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'DEPUTY_HEAD_TEACHER', 'TEACHER', 'CLASS_TEACHER'] },
    { name: 'Financial Engine', href: '/dashboard/finance', icon: CreditCard, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'ACCOUNTANT', 'PARENT'] },
    { name: 'Learning Hub (LMS)', href: '/dashboard/lms', icon: Library, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'DEPUTY_HEAD_TEACHER', 'TEACHER', 'CLASS_TEACHER', 'STUDENT'] },
    { name: 'Institutional Staff', href: '/dashboard/staff', icon: UserCog, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'DEPUTY_HEAD_TEACHER'] },
    { name: 'Payroll Registry', href: '/dashboard/staff/payroll', icon: CreditCard, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'ACCOUNTANT'] },
    { name: 'Leave Management', href: '/dashboard/staff/leaves', icon: Calendar, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'DEPUTY_HEAD_TEACHER', 'TEACHER', 'CLASS_TEACHER', 'LIBRARIAN', 'NURSE', 'MATRON', 'SECURITY', 'DRIVER', 'SUBORDINATE', 'ACCOUNTANT'] },
    { name: 'Transport & Fleet', href: '/dashboard/transport', icon: Bus, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'DRIVER'] },
    { name: 'Hostel & Boarding', href: '/dashboard/hostels', icon: Home, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'MATRON'] },
    { name: 'Resource Library', href: '/dashboard/library', icon: BookText, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'LIBRARIAN'] },
    { name: 'Health & Clinic', href: '/dashboard/health', icon: HeartPulse, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'NURSE'] },
    { name: 'Security & Gate', href: '/dashboard/security', icon: ShieldAlert, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'SECURITY'] },
    { name: 'Messaging Central', href: '/dashboard/messaging', icon: MessageSquare, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER', 'DEPUTY_HEAD_TEACHER', 'TEACHER', 'CLASS_TEACHER'] },
    { name: 'Institutional Settings', href: '/dashboard/settings', icon: Settings, roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN', 'HEAD_TEACHER'] },
  ];
