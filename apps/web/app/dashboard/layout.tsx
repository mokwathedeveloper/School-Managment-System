        ...
        <header className="h-16 bg-card border-b flex items-center justify-between px-4 md:px-8 z-10">
          ...
          <div className="flex items-center gap-2 md:gap-4 ml-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="h-9 w-9 md:h-10 md:w-10 rounded-full border bg-muted/50 flex items-center justify-center hover:bg-primary/10 transition-colors cursor-pointer">
