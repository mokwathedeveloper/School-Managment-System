        ...
        <TouchableOpacity activeOpacity={0.9} style={[styles.card, styles.primaryCard]}>
            ...
            <View style={styles.cardFooterWhite}>
                <View style={styles.metaItem}>
                    ...
                    <Text style={styles.cardSubWhite}>Now • Room 202</Text>
                </View>
            </View>
        </TouchableOpacity>
        ...
        <View style={styles.metricsRow}>
            <View style={[styles.card, styles.metricCard]}>
                <View style={styles.metricHeader}>
                    ...
                    <Text style={styles.metricTrend}>Target Met</Text>
                </View>
                <Text style={styles.metricValue}>{stats?.overview?.attendanceRate || 0}%</Text>
                <Text style={styles.metricLabel}>Subject Attendance</Text>
            </View>
            <View style={[styles.card, styles.metricCard]}>
                <View style={styles.metricHeader}>
                    <BookOpen size={16} color="#8b5cf6" />
                    <Text style={styles.metricTrend}>High</Text>
                </View>
                <Text style={styles.metricValue}>12</Text>
                <Text style={styles.metricLabel}>Grading Queue</Text>
            </View>
        </View>
    </View>
  );
