...
export function SpecialistMobileView({ user, stats }: { user: any, stats: any }) {
  const getIcon = () => {
    switch (user?.role) {
      case 'LIBRARIAN': return BookOpen;
      case 'NURSE': return HeartPulse;
      case 'SECURITY': return ShieldAlert;
      case 'DRIVER': return Bus;
  ...
  return (
    <View>
        ...
        <View style={styles.section}>
            <Text style={styles.sectionTitle}>Registry Operations</Text>
            <TouchableOpacity style={styles.actionCard}>
                <View style={styles.actionInfo}>
                    <Plus size={20} color="#2563eb" />
                    <Text style={styles.actionText}>New Registry Entry</Text>
                </View>
